(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["@infras/ui"] = {}, global.Vue));
  ...
  function render(_ctx, _cache) {
    ...
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [vue.createElementVNode("header", _hoisted_2, [vue.createElementVNode("nav", _hoisted_3, [_hoisted_4, vue.createElementVNode("div", _hoisted_5, [vue.createElementVNode("button", {
      ...
      return vue.openBlock(), vue.createElementBlock("a", {
        ...
        href: item.href,
        "class": "text-sm font-semibold leading-6 text-gray-900"
      }, vue.toDisplayString(item.name), 9
      /* TEXT, PROPS */
      , _hoisted_8);
    }), 128
    /* KEYED_FRAGMENT */
    ))]), _hoisted_9]), vue.createVNode(_component_Dialog, {
      "class": "lg:hidden",
